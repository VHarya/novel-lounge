<script lang="ts">
    ...
    const initialNovel: Novel = data.initNovel;
...
<div class="mb-4">
    ...
    <div class="h-full py-4 flex flex-col justify-end border-b-[1px]">
        ...
        <ul class="ml-4 mb-1.5 list-disc text-sm">
            ...
            <li>Title is required to be filled in</li>
            <li>Pick at least one category for your novel</li>
...
<form bind:this={formElement} action="?/edit" method="post" enctype="multipart/form-data" class="flex flex-col items-end">
    <div class="w-full mb-4 flex flex-col space-x-0 space-y-4 xl:flex-row xl:space-x-4 xl:space-y-0">
        ...
        <div class="w-full flex flex-col">
            <div class="mb-4 flex flex-col">
                ...
                <input type="text" name="title" placeholder="Enter title" bind:value={titleValue} class="border-none rounded-md bg-foreground-alt">
            </div>
